...
public enum DreamfireGameCoreInventoryItem {
    ...
    DreamfireGameCoreInventoryItem(String displayName, Material itemMaterial, List<String> itemLore, List<String> keys, int modelData){
    ...
    public ItemStack ReturnItemStack(){
        ...
        for(var key : keys) DreamfirePersistentItemStack.Add(DreamGameCore.GetDreamfireGameCore(), itemStack, PersistentDataType.STRING, key, key);
        return itemStack;
    }
}